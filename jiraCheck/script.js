...
addBtn.addEventListener("click", function () {
  if (!isModalPresent) {
    modalCont.style.display = "flex"; //modal add ho gya screen pe // flex is needed as we have multiple blocks , but using "block" we will get things on different lines
    // isModalPresent = true;
  } else {
...
//set data //  This will not run on terminal it will run on browser only , as localStorage is a broswer object
